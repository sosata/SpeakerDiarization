 ...
 * Based on:
 * Cheveigne and Kawahara (2002) "YIN, a fundamental frequency estimator for speech and music"
 *
 */
...
public final class Yin implements PitchDetector {
     ...
     */
    public Yin(final double audioSampleRate, final int bufferSize) {
     ...
     */
    public Yin(final double audioSampleRate, final int bufferSize, final double yinThreshold) {
     ...
     */
    public PitchDetectionResult getPitch(final double[] audioBuffer) {
